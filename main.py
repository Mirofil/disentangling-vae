# python main.py --name betaH_fashion2 -d dsprites -l betaH --lr 0.001 -b 16 -e 1 --betaH-B 15 --train_steps 15 --model-type=Higginsconv --plots=all
...
def parse_arguments(args_to_parse):
    ...
    training.add_argument('--calc_fid', type=bool, default=False,
        help='Whether to try and calculate FID')    
